...
const PFavorite = document.getElementById("pokemon-favorite");
...
const renderPokemonData = (data) => {
	...
	localStorage.setItem("id_pokemon", JSON.stringify(data.id));
	setCardColor(types);
...
const renderPokemonStats = (stats) => {
	...
	let btnf = document.getElementById("btn-favorito");
	btnf.textContent = "Favorito";
};
